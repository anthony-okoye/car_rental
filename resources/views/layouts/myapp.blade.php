            ...
            <div class="pt-10 mx-auto max-w-screen-xl relative">
                <div class="md:flex md:justify-between">
                    ...
                    <div class="grid grid-cols-3 gap-8 ">
                        ...
                        <div>
                            ...
                            <ul class="text-gray-400">
                                <li class="mb-4">
                                    <a href="https://github.com/anthony-okoye" class="hover:underline "
                                        target='_blank'>Github</a>
                                </li>
                                <li>
                                    <a href="https://www.linkedin.com/in/tagbo-okoye-666819167" class="hover:underline"
                ...
                <div class="sm:flex sm:items-center sm:justify-between md:ms-0 pb-4  ms-32">
                    <span class="text-sm sm:text-center text-gray-400 md:ms-0 -ms-8">© 2022 <a
                            href="https://www.linkedin.com/in/tagbo-okoye-666819167" target='_blank'
                            class="hover:underline">Tagbo™</a>. All Rights Reserved.
                    </span>
                    <div class="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
                        <a href="https://github.com/anthony-okoye" target='_blank'
                        ...
                        <a href="https://x.com/Okoyeanthonyy" target='_blank'
                            class="text-gray-500 hover:text-white">
                            <svg class="w-8 h-8" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                                <path
                        ...
                        <a href="https://www.linkedin.com/in/tagbo-okoye-666819167" target='_blank'
                            class="text-gray-500  hover:text-white">
                        ...
                        <a href="https://www.instagram.com/anthony__okoye" target='_blank'
                            class="text-gray-500  hover:text-white">
                            <svg class="w-8 h-8" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                                <path fill-rule="evenodd"
